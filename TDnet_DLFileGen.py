...
使い方例:
cd "\\LS720D7A9\TakashiBK\投資\TDNET\TDnet適時情報開示サービス"
    python TDnet_DLFileGen.py --start 20260126 --end 20260130 --out TDNET_Output.xlsx
DL先は　\\LS720D7A9\TakashiBK\投資\TDNET\TDnet適時情報開示サービス
"""
